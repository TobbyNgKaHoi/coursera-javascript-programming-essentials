...
function findEmployeeById(employeeId) {
    ...
    if (foundEmployee) {
        document.getElementById("employeeDetails").innerHTML = `<p>${foundEmployee.id}: ${foundEmployee.name}: ${foundEmployee.department} - ${foundEmployee.specialization} - $${foundEmployee.salary}</p>`;
    } else {
